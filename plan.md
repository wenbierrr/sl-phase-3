...
| **3–5**<br/>24 Aug – 11 Sep | **DE trial** | DEs run the tuned tool against injected faults and whatever real failures arrive, **each case timeboxed to 30 min**. One [rubric](DE-trial-execution.md#de-trial-rubric) scorecard per case, aimed at the **less-experienced DEs** — that is the group the value claim rests on.<br/>*This is where evidence starts.* |
